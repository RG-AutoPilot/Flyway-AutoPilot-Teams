...
COMMENT ON COLUMN ap_dev.contacts.contact_id IS 'Contact ID';
COMMENT ON COLUMN ap_dev.contacts.first_name IS 'First name';
COMMENT ON COLUMN ap_dev.contacts.last_name IS 'Last name';